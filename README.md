...
2. The tool scans for missing values.
3. It analyzes the pattern and mechanism of missingness.
4. Suitable imputation methods are recommended.
5. Users can apply the preferred imputation technique.
6. The tool generates visualizations and comparative statistical summaries.
7. Download the cleaned dataset for further analysis.

## Installation

```bash
git clone https://github.com/your-username/missingmind-ai.git
cd missingmind-ai
